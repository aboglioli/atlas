...
export default [{
  ...
  },
  {
    ...
    config: {
      handler: {
        async: ProductsUploadHandler.post
      },
      auth: {
        strategy: 'jwt',
        scope: ['admin']
