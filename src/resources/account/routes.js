...
export default [{
  ...
  },
  {
    ...
    config: {
      handler: {
        async: AccountLoginHandlers.post
      },
  ...
  },
  {
    ...
    config: {
      handler: {
        async: AccountRegisterHandlers.post
      },
  ...
  },
  {
    ...
    config: {
      handler: {
        async: AccountRegisterHandlers.patch
      },
  ...
  },
  {
    ...
    config: {
      handler: {
        async: AccountResetHandlers.post
      },
  ...
  },
  {
    ...
    config: {
      handler: {
        async: AccountResetHandlers.patch
      },
