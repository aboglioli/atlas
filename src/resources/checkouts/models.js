...
class Checkout {
  ...
  static async create({
    ...
    if (shippingOptions.length === 1) {
      ...
      }, 'Only one shipping option, setting it by default');
   ...
   */
  @DBDecorators.table(tables.Checkout)
  static async updateCustomerDetails(checkoutId, {
    customer
  }) {
   ...
   */
  @DBDecorators.table(tables.Checkout)
  static async updateAddresses(checkoutId, {
    shippingAddress,
    billingAddress
  }) {
   ...
   */
  @DBDecorators.table(tables.Checkout)
  static async updateShippingMethod(checkoutId, {
    shippingMethod
  }) {
   ...
   */
  @DBDecorators.table(tables.Checkout)
  static async updatePaymentMethod(checkoutId, {
    paymentMethod
  }) {
